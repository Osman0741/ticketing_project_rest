...
class ProjectControllerTest {
    ...
    void givenToken_getProjects() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/v1/project")
                ...
                .andExpect(jsonPath("$.data[0].assignedManager.userName").isString())
                .andExpect(jsonPath("$.data[0].assignedManager.userName").value("osman"));
    }
    ...
    private static String getToken() {
        ...
        map.add("client_id", "my-ticketing-app");
        map.add("client_secret", "G1rDPtP8HBKCj56aHDQXBH4oOEDQMg6c");
        map.add("username", "osman");
